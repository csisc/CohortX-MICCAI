      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row justify-center items-center gap-4 mb-12">
            ...
            <a
              href="https://csisc.github.io/CohortX-Videos/"
            ...
            <a
              ...
              className="inline-flex items-center justify-center px-8 py-3.5 text-base font-medium rounded-xl text-green-700 bg-white border border-green-100 hover:bg-green-50 transition-all shadow-sm hover:shadow w-full sm:w-auto"
            >
              Research Posters
            </a>
          </div>
