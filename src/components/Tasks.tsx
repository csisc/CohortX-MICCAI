...
const tasks = [
  ...
  },
  {
    ...
    abstract: '<b><font color="red">This Task has been cancelled by the Organizing Committee, as no one has registered on time (April 30) for it.</font></b><br />Design a robust data model that converts structured eligibility criteria into a semantically rich knowledge graph. Develop ontology-aligned models using established biomedical or core ontologies (e.g., FHIR, OWL, RDFS, SKOS, OBO Foundry).',
    platform: 'OpenReview',
